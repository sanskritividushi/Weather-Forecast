...
def index(request):
    if request.method == 'POST':
        ...
        res = urllib.request.urlopen('http://api.openweathermap.org/data/2.5/weather?q='+city+'&appid=e7c2ab0f4038e880486eb3b2a25c1be9&units=metric').read()
        ...
        forecast_res = urllib.request.urlopen('http://api.openweathermap.org/data/2.5/forecast?q='+city+'&appid=e7c2ab0f4038e880486eb3b2a25c1be9&units=metric').read()
